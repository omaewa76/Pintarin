    ...
    <div>
      ...
      <div className="mt-8 grid gap-6 xl:grid-cols-4">
        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <h2 className="mt-2 text-lg font-bold text-slate-800">Coblong</h2>
        </div>

        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          <p className="text-sm text-slate-500">Tanggal Submit</p>

          <h2 className="mt-2 text-lg font-bold text-slate-800">17 Mei 2026</h2>
        </div>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <h2 className="mt-2 text-lg font-bold text-red-600">92</h2>
        </div>
      </div>
      ...
      <div className="mt-8 grid gap-6 xl:grid-cols-2">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-slate-800">Data Lama</h2>
          ...
          <div className="mt-6 space-y-5">
            ...
            <div>
              <p className="text-sm text-slate-500">Kondisi Infrastruktur</p>

              <h3 className="mt-2 text-lg font-bold text-slate-800">Sedang</h3>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-yellow-300 bg-yellow-50 p-6 shadow-sm">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-slate-800">Data Baru</h2>
          ...
          <div className="mt-6 space-y-5">
            <div>
              ...
              <h3 className="mt-2 text-lg font-bold text-red-600">186 Siswa</h3>
            </div>

            <div>
              <p className="text-sm text-slate-500">Bantuan Aktif</p>

              <h3 className="mt-2 text-lg font-bold text-red-600">Rp 65 JT</h3>
            </div>
      ...
      <div className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        {/* Header */}
        <div>
          <h2 className="text-xl font-bold text-slate-800">Catatan Reviewer</h2>
